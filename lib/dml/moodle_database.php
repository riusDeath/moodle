...
abstract class moodle_database {
    ...
    /**
    * 18/3/2019 by Vu Thi Thuy
    * select database on moodle
    **/

    public function get_my_records_select_menu($table, $select,  array $params=null, $sort='', $fields='*', $limitfrom=0, $limitnum=0) {
        $menu = array();
